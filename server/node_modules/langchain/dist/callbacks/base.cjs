...
exports.ConsoleCallbackHandler = exports.CallbackManager = exports.BaseCallbackManager = exports.BaseCallbackHandler = void 0;
...
class BaseCallbackManager extends BaseCallbackHandler {
    setHandler(handler) {
