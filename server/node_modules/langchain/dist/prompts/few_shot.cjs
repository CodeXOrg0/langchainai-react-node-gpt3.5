...
class FewShotPromptTemplate extends base_js_1.BaseStringPromptTemplate {
    ...
    static async deserialize(data) {
        const serializedPrompt = await (0, index_js_1.resolveConfigFromFile)("example_prompt", data);
        const examplePrompt = await prompt_js_1.PromptTemplate.deserialize(serializedPrompt);
        let examples;
        if (typeof data.examples === "string") {
            examples = await (0, index_js_1.parseFileConfig)(data.examples, ".json", [
                ".json",
                ".yml",
                ".yaml",
            ]);
        ...
        return new FewShotPromptTemplate({
            ...
            prefix: await (0, index_js_1.resolveTemplateFromFile)("prefix", data),
            suffix: await (0, index_js_1.resolveTemplateFromFile)("suffix", data),
