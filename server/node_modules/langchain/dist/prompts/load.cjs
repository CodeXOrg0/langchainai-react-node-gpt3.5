...
const loadPromptFromFile = (text, path) => base_js_1.BasePromptTemplate.deserialize((0, index_js_1.parseFileConfig)(text, path));
/**
...
const loadPrompt = async (uri) => {
    ...
    return (0, index_js_1.loadFromFile)(uri, loadPromptFromFile);
};
