...
exports.TEMPLATE_TOOL_RESPONSE = exports.SUFFIX = exports.FORMAT_INSTRUCTIONS = exports.PREFIX = void 0;
exports.PREFIX = `Assistant is a large language model trained by OpenAI.
